...
model: SingleShotMaskDetector = torch.load(
            "models/coco-ssd-mobilevitv2-0.75_2nc_2np_structure.pt", map_location="cpu", weights_only=False)
...
torch.save(model, "models/coco-ssd-mobilevitv2-0.75_2nc_5np_pretrained.pt")

...
model: SingleShotMaskDetector = torch.jit.load(
            "models/SingleShotMaskDetector_jit.pt", map_location="cpu")
print(model)
...
#         checkpoint.pop(k)
#
# torch.save(checkpoint, "models/coco-ssd-mobilevitv2-0.75_2nc_weights.pt")
